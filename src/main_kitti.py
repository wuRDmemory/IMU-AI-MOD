...
class KITTIDataset(BaseDataset):
    ...
    if CUSTOM != 1:
        ...
        datasets_fake = ['2019_05_24_drive_0003_sync']
    """
    ...
    if CUSTOM != 1:
        ...
        odometry_benchmark["2019_05_24_drive_0001_sync"] = [0, 3496]
        odometry_benchmark["2019_05_24_drive_0002_sync"] = [0, 6669]
        # odometry_benchmark["2019_05_24_drive_0003_sync"] = [0, 1970]
        odometry_benchmark["2019_05_24_drive_0004_sync"] = [0, 3000]
        odometry_benchmark["2019_05_24_drive_0005_sync"] = [0, 4173]
        odometry_benchmark["2019_05_24_drive_0006_sync"] = [0, 3691]
    ...
    def __init__(self, args):
        ...
        if CUSTOM != 1:
            ...
            self.datasets_validatation_filter['2019_05_24_drive_0006_sync'] = [0, 3691]
            self.datasets_train_filter["2019_05_24_drive_0001_sync"] = [0, 3496]
            self.datasets_train_filter["2019_05_24_drive_0002_sync"] = [0, 6669]
            self.datasets_train_filter["2019_05_24_drive_0005_sync"] = [0, 4173]
            self.datasets_train_filter["2019_05_24_drive_0004_sync"] = [0, 3000]
            self.datasets_train_filter["2019_05_24_drive_0006_sync"] = [0, 3000]
    ...
    @staticmethod
    def custom_pose_from_oxts_packet(packet, scale):
        """Helper method to compute a SE(3) pose matrix from an OXTS packet.
        """

        # Use a Mercator projection to get the translation vector
        t = np.array([packet.lat, packet.lon, packet.alt])
            ...
            with open(filename, 'r') as f:
                for line in f.readlines():
                    ...
                    if CUSTOM != 1:
                        ...
                        scale= 1
                        R, t = KITTIDataset.custom_pose_from_oxts_packet(packet, scale)
...
class KITTIArgs():
        ...
        path_data_base = "../custom_data"
        if CUSTOM != 1:
            path_data_save = "../data"
        else:
            path_data_save = "../data1"
        ...
        cross_validation_sequences = ['2019_05_24_drive_006_sync']
        test_sequences = ['2019_05_24_drive_005_sync']
